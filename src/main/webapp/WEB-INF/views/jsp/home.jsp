...
<button class="content-buttons">Insert Students </button></form>
<form action="/ui/deletelist" method="post">
<button class="content-buttons" type="submit">Delete Student</button></div></form>
<br></br>
<div class="button-split">
<form action="/ui/submittedlist" method="post">
<button class="content-buttons" type="submit">View DataBase Entries</button></form>
<form action="/ui/update" method="post">
<button class="content-buttons" type="submit">Update Student Entries</button>
</form></div>
